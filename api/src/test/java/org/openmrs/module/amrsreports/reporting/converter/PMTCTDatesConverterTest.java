...
public class PMTCTDatesConverterTest {
	/**
	 * @verifies convert a list of dates
	 * @see PMTCTDatesConverter#convert(Object)
	 */
	@Test
	public void convert_shouldConvertAListOfDates() throws Exception {
		...
		String actual = (String) new PMTCTDatesConverter().convert(dateList);
	...
	public void convert_shouldReturnABlankStringIfNoDatesExist() throws Exception {
		String expected = "";
		String actual = (String) new PMTCTDatesConverter().convert(Collections.emptySet());
		assertEquals(actual, expected);
	}
	...
	public void convert_shouldReturnNullIfTheParameterIsNull() throws Exception {
		...
		String actual = (String) new PMTCTDatesConverter().convert(null);
		assertEquals(actual, expected);
	}
}
