	...
	public boolean eligible() {
		...
		if (!ageGroup.equals(MohEvaluableNameConstants.AgeGroup.ABOVE_TWELVE_YEARS)) {
			if (this.getProperty("pedsWHOStage").equals(4)) {
				...
				return true;
			} else if (this.getProperty("pedsWHOStage").equals(3) && (Double) this.getProperty("cd4ByFacs") < Double.valueOf(500) && (Double) this.getProperty("cd4PercentByFacs") < Double.valueOf(25)) {
		...
		if (ageGroup.equals(MohEvaluableNameConstants.AgeGroup.UNDER_EIGHTEEN_MONTHS)) {
			if (this.getProperty("pedsWHOStage").equals(2) && (Double) this.getProperty("cd4ByFacs") < Double.valueOf(500) && (Boolean) this.getProperty("HIVDNAPCRPositive")) {
				...
				&& (this.getProperty("pedsWHOStage").equals(1) || this.getProperty("pedsWHOStage").equals(2)) && (Double) this.getProperty("cd4PercentByFacs") < Double.valueOf(20)) {
			this.setProperty("reason", REASON_CLINICAL_CD4);
			return true;
		} else if (ageGroup.equals(MohEvaluableNameConstants.AgeGroup.FIVE_YEARS_TO_TWELVE_YEARS)
				&& (this.getProperty("pedsWHOStage").equals(1) || this.getProperty("pedsWHOStage").equals(2)) && (Double) this.getProperty("cd4PercentByFacs") < Double.valueOf(25)) {
			this.setProperty("reason", REASON_CLINICAL_CD4);
			return true;
		} else if (ageGroup.equals(MohEvaluableNameConstants.AgeGroup.ABOVE_TWELVE_YEARS)) {
			if ((this.getProperty("pedsWHOStage").equals(1) || this.getProperty("pedsWHOStage").equals(2)) && (Double) this.getProperty("cd4ByFacs") < Double.valueOf(350)) {
				this.setProperty("reason", REASON_CLINICAL_CD4);
				return true;
			} else if (this.getProperty("adultWHOStage").equals(4) || this.getProperty("adultWHOStage").equals(3)) {
				this.setProperty("reason", REASON_CLINICAL);
				return true;
			} else if ((this.getProperty("adultWHOStage").equals(1) || this.getProperty("adultWHOStage").equals(2)) && (Double) this.getProperty("cd4ByFacs") < Double.valueOf(350)) {
				this.setProperty("reason", REASON_CLINICAL_CD4);
				return true;
			}
		}
